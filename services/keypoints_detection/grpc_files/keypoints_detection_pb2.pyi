...
class KeypointsDetectionResponse(_message.Message):
    ...
    def __init__(
        ...
        keypoints: _Optional[_Iterable[_Union[Keypoint, _Mapping]]] = ...
    ) -> None: ...

class BoundingBox(_message.Message):
    __slots__ = ("x1_n", "y1_n", "x2_n", "y2_n", "confidence", "class_label")
